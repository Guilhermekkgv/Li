...
Linux.Themes = {
    ...
    BlackWhite = Color3.fromRGB(255, 255, 255)
}
...
function Linux.RegisterTransparencyElement(element, tabIndex)
    table.insert(Linux.TransparencyElements, {element = element, tabIndex = tabIndex})
end
...
function Linux.ApplyTransparency(enabled, value)
    ...
    for _, elementData in pairs(Linux.TransparencyElements) do
        local element = elementData.element
        local tabIndex = elementData.tabIndex
        ...
        if element and element.Parent and element.Name ~= "Section" then
            ...
            if enabled then
                if tabIndex == Linux.CurrentTab then
                    targetTransparency = Linux.TransparencyValue
                else
                    targetTransparency = element:GetAttribute("OriginalTransparency") or 0.8
                end
            else
                targetTransparency = element:GetAttribute("OriginalTransparency") or 0.8
            end
...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        TabBtn:SetAttribute("OriginalTransparency", 1)
        Linux.RegisterTransparencyElement(TabBtn, tabIndex)
        ...
        function TabElements.Button(config)
            ...
            Linux.RegisterTransparencyElement(BtnFrame, tabIndex)
        ...
        function TabElements.Toggle(config)
            ...
            Linux.RegisterTransparencyElement(Toggle, tabIndex)
            ...
            local function UpdateToggle(thisToggle)
                ...
                if thisTrack and thisKnob then
                    ...
                    if currentState then
                        if Linux.CurrentTheme == "BlackWhite" then
                            TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                            TweenService:Create(thisKnob, tween, {Position = UDim2.new(0, 20, 0.5, -7), BackgroundColor3 = Color3.fromRGB(0, 0, 0)}):Play()
                        else
        ...
        function TabElements.Dropdown(config)
            ...
            Linux.RegisterTransparencyElement(Dropdown, tabIndex)
            ...
            Linux.RegisterTransparencyElement(DropFrame, tabIndex)
            ...
            Linux.RegisterTransparencyElement(OptionsHolder, tabIndex)
        ...
        function TabElements.Slider(config)
            ...
            Linux.RegisterTransparencyElement(Slider, tabIndex)
            ...
            local FillBar = Linux.Instance("Frame", {
                Parent = SliderBar,
                BackgroundColor3 = Linux.CurrentTheme == "BlackWhite" and Color3.fromRGB(255, 255, 255) or Linux.Themes[Linux.CurrentTheme],
                Size = UDim2.new(0, 0, 1, 0),
                ZIndex = 2,
                BorderSizePixel = 1,
                BorderColor3 = Color3.fromRGB(39, 39, 42),
            ...
            local SliderKnob = Linux.Instance("Frame", {
                Parent = SliderBar,
                BackgroundColor3 = Linux.CurrentTheme == "BlackWhite" and Color3.fromRGB(0, 0, 0) or Color3.fromRGB(255, 255, 255),
        ...
        function TabElements.Input(config)
            ...
            Linux.RegisterTransparencyElement(Input, tabIndex)
        ...
        function TabElements.Label(config)
            ...
            Linux.RegisterTransparencyElement(LabelFrame, tabIndex)
        ...
        function TabElements.Paragraph(config)
            ...
            Linux.RegisterTransparencyElement(ParagraphFrame, tabIndex)
    ...
    if config.ConfigSave ~= false then
        ...
        local themeDropdown = SettingsTab.Dropdown({
            Name = "Select Accent",
            Options = {"Orange", "Purple", "Blue", "Red", "Green", "BlackWhite"},
        ...
        local transparencyToggle = SettingsTab.Toggle({
            ...
            Callback = function(state)
                Linux.ApplyTransparency(state, 0.4)
